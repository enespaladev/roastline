        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1">
                ...
                <a href="{{ route('admin.videos.index') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.videos*') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }} transition">
            ...
            <div class="px-4 py-4 border-t border-gray-700">
                <form method="POST" action="{{ route('admin.logout') }}">
                    @csrf
                    <button type="submit"
                        class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-400 hover:bg-gray-800 hover:text-white transition w-full">
